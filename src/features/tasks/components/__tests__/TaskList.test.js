...
describe('TaskList.vue', () => {
  ...
  describe('Edge Cases', () => {
    ...
    // Note: Virtual scrolling with large task lists is tested in E2E performance tests
    // (tests/e2e/performance.spec.js) as it requires viewport and proper DOM mounting
